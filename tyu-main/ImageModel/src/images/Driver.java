...
public class Driver {
  ...
  public static void main(String[] args) throws IOException {
    int[][][] image =
        ImageUtilities.readImage("C:\\Users\\pc\\IdeaProjects\\ImageModel\\src\\Capture.PNG");

    Chunking pixelate = new Pixelation(image);
    int[][][] newImage = pixelate.apply(50);
    ImageUtilities.writeImage(newImage, newImage[0].length, newImage.length, "pixelated.jpg");
