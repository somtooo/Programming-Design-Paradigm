...
public class CharacterTest {
  ...
  public void testCreateCharacter() {
    assertEquals(
        "I am John my current gear load out is\n"
            ...
            + "and a Defense Power of 50 which brings my Hit Points to 150, trust me I am gonna\n"
  ...
  public void getHitPoints() {
    ...
    assertEquals(250, character.getHitPoints());
  }
  ...
  public void testAddBetterGearToHeadSlot() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            + " HATS of flight.     I have an Attack Power of 50 \n"
            + "and a Defense Power of 170 which brings my Hit Points to 270, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
  ...
  public void addBetterGearToHandSlot() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            + "   GLOVE of love,  of love,  of love,  of love,  of love,  of love,  of love,  "
            + "of love,  of love and of strength.   I have an Attack Power of 1070 \n"
            + "and a Defense Power of 1050 which brings my "
            + "Hit Points to 1150, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
  ...
  public void addWorseGearToHandSlot() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            + "   GLOVE of love,  of love,  of love,  of love,  of love,  of love,  "
            + "of love,  of love,  of love and of love.   I have an Attack Power of 1050 \n"
            + "and a Defense Power of 1050 which brings my Hit Points "
            + "to 1150, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
  ...
  public void wearOutWearableItems() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            ...
            + "and a Defense Power of 130 which brings my Hit Points to 230, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
  ...
  public void testToString() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            + " HATS of total defense.  BOOTS of flight.  GLOVE of hate. "
            + " AMULET of love.  I have an Attack Power of 350 \n"
            + "and a Defense Power of 350 which brings my Hit Points to 450, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
  ...
  public void describeWearable() {
    ...
    assertEquals(
        "I am John my current gear load out is\n"
            + " HATS of total defense.  BOOTS of flight and of flight.  "
            + "GLOVE of hate.  AMULET of love.  I have an Attack Power of 320 \n"
            + "and a Defense Power of 350 which brings my Hit Points to 450, trust me I am gonna\n"
            + " beat the Java out of you!!!!",
        character.toString());
  }
