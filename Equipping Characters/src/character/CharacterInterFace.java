...
public interface CharacterInterFace {
  ...
  /**
   * Calculates the total attack and defense power of a character, this should be called after every
   * equip.
   */
  ...
  /**
   * Wears out items that isWear is true if the item is not an item that wears out then it does
   * nothing.
   */
