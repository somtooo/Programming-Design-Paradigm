...
public class HandGear extends AbstractWearable implements AttackWearable,DefenceWearable {
     ...
     */
    public HandGear(HandGearName handGearName, String description, Boolean wearsOut, int attackPower, int defensePower) throws IllegalArgumentException {
    ...
    public String toString() {
        return String.format("Name: %s, Description: %s, AttackPower: %s, DefensePower: %s, Wears Out: %s ", handGearName,description,attackPower,defensePower,wearsOut);
    }
